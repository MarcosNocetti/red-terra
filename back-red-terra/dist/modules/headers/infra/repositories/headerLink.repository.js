...
exports.HeaderLinkRepository = void 0;
const common_1 = require("@nestjs/common");
const entities_1 = require("../../../../entities");
const typeorm_1 = require("typeorm");
let HeaderLinkRepository = class HeaderLinkRepository {
    constructor(dataSource) {
        this.dataSource = dataSource;
        this.repository = dataSource.getRepository(entities_1.HeaderLinkEntity);
    }
    async save(data) {
...
HeaderLinkRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeorm_1.DataSource])
], HeaderLinkRepository);
exports.HeaderLinkRepository = HeaderLinkRepository;
//# sourceMappingURL=headerLink.repository.js.map