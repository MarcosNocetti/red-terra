...
let CreditsRepository = class CreditsRepository {
    constructor(dataSource) {
        this.dataSource = dataSource;
        this.repository = dataSource.getRepository(entities_1.CreditEntity);
    }
    async save(data) {
...
CreditsRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeorm_1.DataSource])
], CreditsRepository);
exports.CreditsRepository = CreditsRepository;
//# sourceMappingURL=credits.repository.js.map