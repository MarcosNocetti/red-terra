...
let NewsController = class NewsController {
    constructor(newsService, newsRelationRepository) {
    ...
    async getNewsByWhatsHappening(id) {
        try {
    ...
    async updateNews(id, data) {
        const result = await this.newsService.update(Object.assign(Object.assign({}, data), { id }));
        return Object.assign(Object.assign({}, result.value), { statusCode: result.isFailure()
                ? common_1.HttpStatus['NOT_ACCEPTABLE']
                : common_1.HttpStatus['OK'] });
    }
...
__decorate([
    (0, common_1.Get)('/whatsHappening/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], NewsController.prototype, "getNewsByWhatsHappening", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.NewsDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.UpdateNewsDto]),
    __metadata("design:returntype", Promise)
...
NewsController = __decorate([
    ...
    __metadata("design:paramtypes", [services_1.NewsService,
