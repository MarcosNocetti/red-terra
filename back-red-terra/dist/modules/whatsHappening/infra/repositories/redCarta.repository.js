...
exports.RedCartaRepository = void 0;
const common_1 = require("@nestjs/common");
const entities_1 = require("../../../../entities");
const typeorm_1 = require("typeorm");
let RedCartaRepository = class RedCartaRepository {
    constructor(dataSource) {
        this.dataSource = dataSource;
        this.repository = dataSource.getRepository(entities_1.RedCartaEntity);
    }
    async save(data) {
...
RedCartaRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeorm_1.DataSource])
], RedCartaRepository);
exports.RedCartaRepository = RedCartaRepository;
//# sourceMappingURL=redCarta.repository.js.map