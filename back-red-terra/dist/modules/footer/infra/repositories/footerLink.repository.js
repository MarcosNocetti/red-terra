...
exports.FooterLinkRepository = void 0;
const common_1 = require("@nestjs/common");
const entities_1 = require("../../../../entities");
const typeorm_1 = require("typeorm");
let FooterLinkRepository = class FooterLinkRepository {
    constructor(dataSource) {
        this.dataSource = dataSource;
        this.repository = dataSource.getRepository(entities_1.FooterLinkEntity);
    }
    async save(data) {
...
FooterLinkRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeorm_1.DataSource])
], FooterLinkRepository);
exports.FooterLinkRepository = FooterLinkRepository;
//# sourceMappingURL=footerLink.repository.js.map