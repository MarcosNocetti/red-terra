...
exports.RdnRepository = void 0;
const common_1 = require("@nestjs/common");
const entities_1 = require("../../../../entities");
const typeorm_1 = require("typeorm");
let RdnRepository = class RdnRepository {
    constructor(dataSource) {
        this.dataSource = dataSource;
        this.repository = dataSource.getRepository(entities_1.RdnEntity);
    }
    async save(data) {
...
RdnRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeorm_1.DataSource])
], RdnRepository);
exports.RdnRepository = RdnRepository;
//# sourceMappingURL=rdn.repository.js.map