...
exports.TeamPeopleRepository = void 0;
const common_1 = require("@nestjs/common");
const entities_1 = require("../../../../entities");
const typeorm_1 = require("typeorm");
let TeamPeopleRepository = class TeamPeopleRepository {
    constructor(dataSource) {
        this.dataSource = dataSource;
        this.repository = dataSource.getRepository(entities_1.TeamPeopleEntity);
    }
    async save(data) {
...
TeamPeopleRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeorm_1.DataSource])
], TeamPeopleRepository);
exports.TeamPeopleRepository = TeamPeopleRepository;
//# sourceMappingURL=teamPeople.repository.js.map