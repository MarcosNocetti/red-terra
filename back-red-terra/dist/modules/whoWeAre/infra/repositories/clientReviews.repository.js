...
exports.ClientReviewsRepository = void 0;
const common_1 = require("@nestjs/common");
const entities_1 = require("../../../../entities");
const typeorm_1 = require("typeorm");
let ClientReviewsRepository = class ClientReviewsRepository {
    constructor(dataSource) {
        this.dataSource = dataSource;
        this.repository = dataSource.getRepository(entities_1.ClientReviewEntity);
    }
    async save(data) {
...
ClientReviewsRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeorm_1.DataSource])
], ClientReviewsRepository);
exports.ClientReviewsRepository = ClientReviewsRepository;
//# sourceMappingURL=clientReviews.repository.js.map