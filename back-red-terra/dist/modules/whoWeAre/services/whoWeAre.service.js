...
exports.WhoWeAreService = void 0;
const common_1 = require("@nestjs/common");
const errors_1 = require("../../../shared/errors");
const repositories_1 = require("../infra/repositories");
let WhoWeAreService = class WhoWeAreService {
    ...
    async update(data) {
        const { id } = data, updatedWhoWeAre = __rest(data, ["id"]);
        ...
        const whatWeDo = await this.whatWeDoRepository.save(Object.assign(Object.assign({}, whatWeDoExists), updatedWhoWeAre));
        return (0, errors_1.success)({
            data: whatWeDo,
...
WhoWeAreService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [repositories_1.WhoWeAreRepository])
], WhoWeAreService);
exports.WhoWeAreService = WhoWeAreService;
//# sourceMappingURL=whoWeAre.service.js.map